...
// sender user constants
export const SENDER_USER_REQUEST = "SENDER_USER_REQUEST";
export const SENDER_USER_SUCCESS = "SENDER_USER_SUCCESS";
export const SENDER_USER_FAILS = "SENDER_USER_FAILS";
...
export const MESSAGE_FAILS = "MESSAGE_FAILS";
